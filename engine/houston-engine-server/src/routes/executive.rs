...
//!
//! GET/PUT `/v1/workspaces/:workspace_id/executive-config` — read/write the
//! workspace-level executive configuration.
//!
//! POST `/v1/workspaces/:workspace_id/executive/briefing` — trigger a parallel
//! sub-session sweep across connected agents and start the director's main
//! session with the aggregated context.
...
use houston_engine_protocol::{ExecutiveBriefingRequest, ExecutiveBriefingResponse, ExecutiveConfig};
